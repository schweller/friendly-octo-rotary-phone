...
function IndicatorMessagesList() {
  ...
  const { isLoading, messages, filters } = useSelector(
    (state: RootState) => state.indicatorMessages
  );

  const handleFilters = useCallback(
    (values: FiltersFormValues) => {
      const truthyFilters = Object.keys(values).reduce(
        (acc: Array<FilterParams>, key) => {
